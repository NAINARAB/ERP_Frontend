...
import { creditNoteExpencesInfo } from "./variable";
...
const ExpencesOfCreditNote = ({
    ...
    const addNewRow = () => {
        setInvoiceExpences(prev => [...prev, { ...creditNoteExpencesInfo, Sno: prev.length }]);
    };
...
export default ExpencesOfCreditNote;
