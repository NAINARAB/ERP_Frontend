...
import { creditNoteStaffInfo } from "./variable";
import { checkIsNumber, isEqualNumber, reactSelectFilterLogic, toArray } from "../../../Components/functions";
import { customSelectStyles } from "../../../Components/tablecolumn";
import { Delete } from "@mui/icons-material";
import Select from "react-select";

const InvolvedStaffsCreditNote = ({ StaffArray = [], setStaffArray, costCenter = [], costCategory = [] }) => {
        ...
        <>
            <div className="d-flex align-items-center flex-wrap mb-2 border-bottom pb-2">
                ...
                <Button
                    ...
                    color="primary"
                    type="button"
                    onClick={() => setStaffArray(pre => [...pre, { ...creditNoteStaffInfo }])}
                >
                    Add
                </Button>
            </div>
...
export default InvolvedStaffsCreditNote;
