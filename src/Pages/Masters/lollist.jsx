...
import {
    Table, TableBody, TableCell, tableCellClasses, TableContainer, TableHead,
    TableRow, Paper, TablePagination, Select, MenuItem, FormControl, InputLabel, Box,
    Typography, IconButton, Tooltip, Switch, Dialog, DialogTitle, DialogContent,
...
const PROTECTED_COLUMNS = ['Auto_Id', 'Ledger_Tally_Id', 'Ledger_Name', 'Ledger_Alias', 'Actual_Party_Name_with_Brokers'];
...
function Lollist() {
    ...
    const handleSaveChanges = async () => {
        try {
            ...
            setAllData((prevData) =>
                prevData.map((row) => (row.Auto_Id === editedData.Auto_Id ? editedData : row))
            );
