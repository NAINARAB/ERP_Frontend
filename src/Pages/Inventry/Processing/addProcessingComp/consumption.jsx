                ...
                <CreatableSelect
                    ...
                    onChange={e => {
                        ...
                        if (selectedBatch) {
                            ...
                            changeSourceValue(index, 'Sour_Batch_Alias', selectedBatch.batch_alias || selectedBatch.batch || '');
                            ...
                            changeSourceValue(index, 'Batch_Id', selectedBatch.id || '');
                        } else {
                            changeSourceValue(index, 'Sour_Batch_Lot_No', e.value || '');
                            changeSourceValue(index, 'Sour_Batch_Alias', e.value || '');
                            changeSourceValue(index, 'Batch_Id', '');
                        }
                    }}
                    options={
                        batchDetails
                            .filter(b =>
                                checkIsNumber(row?.Sour_Goodown_Id, 1)
                                    ? isEqualNumber(b.godown_id, row?.Sour_Goodown_Id) && toNumber(b.pendingQuantity) !== 0
