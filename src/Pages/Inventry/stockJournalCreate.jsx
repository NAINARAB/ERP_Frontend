...
import { Addition, Division, ISOString, Multiplication, checkIsNumber, getSessionUser, isEqualNumber, isGraterNumber } from "../../Components/functions"
  ...
  const saveStockJournal = () => {
    ...
    fetchLink({
      ...
      bodyData: {
        ...
        Source: destinationList.filter(item => checkIsNumber(item?.Dest_Item_Id) && isGraterNumber(item.Dest_Qty, 0)),
        Source: staffInvolvedList.filter(item => checkIsNumber(item?.Staff_Id)),
      }
    }).then(data => {
      if (data.success) {
        resetForm();
                  ...
                  <div className="row px-2">
                    ...
                    <div className="col-lg-3 col-sm-4 p-2">
                      ...
                      <select
                        ...
                        onChange={e => setStockJorunalInfo({ ...stockJorunalInfo, Branch_Id: e.value })}
