                                ...
                                <fieldset disabled={isPreview} style={{ border: 'none', padding: 0, margin: 0 }}>
                                    <div className='row'>
                                        ...
                                        <div className="col-xl-3 col-md-4 col-sm-6 p-2">
                                            ...
                                            <Select
                                                value={commonGodown}
                                                options={toArray(godownData).map(obj => ({
                                                    value: obj?.Godown_Id,
                                                    label: obj?.Godown_Name
                                                }))}
                                                onChange={e => {
                                                    setCommonGodown(e);
                                                    if (!isValidNumber(invoiceInfo.Do_Id)) {
                                                        setInvoiceInfo(pre => ({ ...pre, Voucher_Type: '' }));
                                                    }
                                                }}
                                                isSearchable={true}
                                                styles={customSelectStyles}
                                            ...
                                            <Select
                                                ...
                                                options={[
                                                    ...
                                                    ...toArray(voucherType).filter(
                                                        fil => isEqualNumber(fil.GodownId, commonGodown.value)
                                                    ).map(obj => ({
                                                ...
                                                maxMenuHeight={300}
                                                filterOption={reactSelectFilterLogic}
                                                isDisabled={isValidNumber(invoiceInfo.Do_Id) || !isValidNumber(commonGodown.value)}
                                            />
                                        </div>
                                ...
                                <fieldset disabled={isPreview} style={{ border: 'none', padding: 0, margin: 0 }}>
                                    <div className="row">
                                        ...
                                        <div className="col-xl-3 col-md-4 col-sm-6 p-2">
                                            ...
                                            <input
                                                className={`cus-inpt p-2 ${!isEqualNumber(retailerSalesStatus?.creditBillLimitCount, 0)
