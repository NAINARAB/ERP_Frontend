                            ...
                            children: (
                                <div className='row'>
                                        ...
                                        <Select
                                            ...
                                            options={[
                                                ...
                                                ...toArray(voucherType).filter(
                                                    fil => fil?.Type === 'DEBIT_NOTE' // Adjust according to your DB Type
                                                ).map(obj => ({
                                            ...
                                            maxMenuHeight={300}
                                            filterOption={reactSelectFilterLogic}
                                            isDisabled={isValidNumber(invoiceInfo.DB_Id)}
                                        />
                                    </div>
                                    ...
                                    <div className="col-xl-3 col-md-4 col-sm-6 p-2">
                                        ...
                                        <input
                                            value={invoiceInfo?.DB_Date ? ISOString(invoiceInfo.DB_Date) : ""}
                                            type="date"
                                            required
                                            className={inputStyle}
                                            onChange={e => setInvoiceInfo(pre => ({ ...pre, DB_Date: e.target.value }))}
                                        />
                                    </div>
                                    ...
                                    {isValidNumber(invoiceInfo?.DB_Id) && (
                                        <div className="col-xl-3 col-md-4 col-sm-6 p-2">
...
export default ManageDebitNoteGeneralInfo;
