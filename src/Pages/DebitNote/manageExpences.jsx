...
import { debitNoteExpencesInfo } from "./variable";
...
const ExpencesOfDebitNote = ({
    ...
    const addNewRow = () => {
        setInvoiceExpences(prev => [...prev, { ...debitNoteExpencesInfo, Sno: prev.length }]);
    };
...
export default ExpencesOfDebitNote;
